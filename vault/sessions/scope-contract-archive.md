---
title: Scope Contract Archive (Sessions 5-31)
type: reference
status: archived
created: 2026-06-05
...
PF attestations, moved out of `HANDOFF.md` at S32 (2026-06-05) to keep the active
handoff lean. The CURRENT session's scope contract stays in `HANDOFF.md`; this file
is the archaeology for Sessions 5-31. Newest first. (Two `Session 5` blocks are
preserved as they existed in the handoff.)

...
### LM-02 — Oura ring purchase + first 30-day wearable baseline
- **date:** TBD (pending Walter)
- **relevant_scopes:** `vault/meta/current-state.md` Wearable (Oura) section; `vault/biomarkers/hrv.md` (TODO); `vault/biomarkers/rhr.md` (TODO); `vault/biomarkers/sleep-efficiency.md` (TODO)
- **trigger_windows:**
  - **purchase + 30 days:** ingest first 30-day baseline into `current-state.md` Wearable section; create biomarker pages with `last_verified` set to the 30-day window end
- **status:** active
- **rationale:** First continuous-measurement biomarkers become available; current-state.md transitions from labs-only to labs+wearable. Specialist agents (recovery-specialist, sleep-coach) gain queryable data.

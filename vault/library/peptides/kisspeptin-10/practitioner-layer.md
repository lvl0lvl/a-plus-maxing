...
| MW | ~1302 Da | ~6.3 kDa |
| Plasma t½ | ~4 min IV; 55 sec in vitro | ~28–32 min |
...
5. **Dhillo WS, et al. "Kisspeptin-10 Is a Potent Stimulator of LH and Increases Pulse Frequency in Men."** Journal of Clinical Endocrinology & Metabolism. 2011;96(8):E1228–E1236. PMC3380939. tag=open_label. tier=2. (IV bolus doses 0.01–3.0 μg/kg in healthy men; max LH at 1.0 μg/kg; high-dose [3 μg/kg] blunting suggesting receptor desensitization; 22.5-h high-dose infusion [4 μg/kg·h] — no tachyphylaxis during the infusion period itself; KP-10 plasma t½ ~4 min IV. Cited for academic dosing parameters and t½ data ONLY; not a practitioner protocol.)
...
7. **Jayasena CN, et al. "Direct comparison of the effects of intravenous kisspeptin-10, kisspeptin-54 and GnRH on gonadotrophin secretion in healthy men."** Clinical Endocrinology. 2015;82(6):882–890. PMC4507333. tag=open_label. tier=2. (IV infusion at 0.1, 0.3, 1.0 nmol/kg/h × 3 h; KP-10 and KP-54 produced comparable LH responses despite 7-fold plasma level difference; both ~3-fold lower than GnRH. Plasma t½ KP-10 4 min vs. KP-54 27.6 min confirmed. References prior chronic KP-54 tachyphylaxis in other populations. Academic dosing context ONLY.)

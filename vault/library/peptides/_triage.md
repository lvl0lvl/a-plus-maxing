...
Order (BPC-157 done): **TB-500 ✅** → **GHK-Cu ✅** → **KPV ✅** → **LL-37 ✅ (#181)** → **Ipamorelin ✅ (#185)** → **CJC-1295 ✅ (#186)** → **Tesamorelin ✅ (#188)** → **Sermorelin ✅**
...
**Next (my/primary lane): Hexarelin.** (Sweep split across two sessions 2026-06-20 — primary session: top 12 incl. LL-37/Ipamorelin/CJC-1295/Tesamorelin/Sermorelin✅; `feature/wiki-peptides`: bottom 13 [MOTS-c…Semax]. Neither deep-passes the other's set.) This sweep is the peptide-library track only — disjoint from the biomarker

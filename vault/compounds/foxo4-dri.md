...
- route:              IP/IV in all published animal studies; subcutaneous not evaluated in any published study; oral bioavailability nil (large peptide, GI proteolysis despite D-chirality); no human route validated. **Grey-market reality: SC doses of 250–500 mcg/day circulate online — these are approximately 700–1,400× below a naive allometric equivalent of the published 5 mg/kg mouse IP dose, and SC bioavailability is entirely uncharacterized; real-world grey-market doses are likely pharmacologically negligible even if the product is correctly synthesized and chiral.**
- timing:             n/a (library entry)
- cycle:              no validated cycle for humans; five-day course in Baar 2017; up to one month in Hu 2025 aged mice
- stack:              n/a
...
- monitoring:           [[biomarkers/egfr]] (renal function — Baar 2017 measured BUN/creatinine as primary safety and efficacy readout; eGFR/creatinine at baseline, day 7, and day 30 post-dose); [[biomarkers/alt]] + [[biomarkers/ast]] (hepatic function — baseline + day 7 + day 30); cardiac troponin I/T + CK-MB (no dedicated biomarker page yet — REQUIRED monitoring; baseline, 48 hours, and 7 days post-dose; these are the highest-consequence safety items given the uncharacterized cardiotoxicity concern [Zhang 2020] and the Born/Adnot 2023 pulmonary adverse finding — a plan following only [[biomarkers/...]] links would miss these); CBC with differential (baseline + monitoring — p53 effects on platelet precursors uncharacterized); anti-drug antibody assay (day 30 and 90 — all-D-amino acid immunogenicity entirely unknown in humans). **No validated pharmacodynamic biomarker of FOXO4-DRI senolytic activity in humans exists; the entire monitoring panel is SAFETY/toxicity monitoring only, NOT efficacy confirmation.**
...
- [[biomarkers/alt]]
- [[biomarkers/ast]]
- [[compounds/humanin]] — see also: other aging-context peptides in this wiki (no direct mechanistic relationship to FOXO4-DRI established in the evidence)
- [[compounds/mots-c]] — see also: other aging-context peptides in this wiki (no direct mechanistic relationship to FOXO4-DRI established in the evidence)

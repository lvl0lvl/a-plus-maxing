...
All 4 active landmarks (LM-01 doctor visit July 2026, LM-02 Oura/wearable, LM-03 23andMe, LM-04 first HTML artifact) — no trigger windows opened during S29 (2026-06-04). LM-04 (first HTML artifact) now has its generation tasks (`ADR-0004-T1`/`T2`/`T3`, `ADR-0007-T2`) recipe-pinned with executable beads (Waves 3-7, unbuilt). LM-01's 14-day-before window still depends on the TBD July exact date (not yet within window as of 2026-06-04); LM-02/03 remain Walter-pending. No status flips due.

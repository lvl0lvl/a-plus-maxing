...
- **Beads:** closed `1oag` (merge provenance #118); new HIST-2 follow-up (promote `loop_schema._reading`/`_content_tag` to a public store constructor — the two-consumer trigger, non-blocking). Still OPEN and next-up: the calendar-event + 30-day-rollup data models; `b6um`, `e3b`, `02pe`, `r3pq`, `5zfk`, the S52 governance tail, `1ww`, `pq7m`.

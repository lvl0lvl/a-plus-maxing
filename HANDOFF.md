...
- **AC5 (no regression) — PASS.** Full `.venv/bin/python -m pytest` 238→**247 passed / 2 skipped** (+9 Tier-3 tests over the +10 build); the 2 skips are the pre-existing Linux-only egress-namespace tests; hook/shell baseline suites green.
...
Scope contracts for Sessions 5-40 + their evaluations were moved to `vault/sessions/scope-contract-archive.md` (S32 archived the S5-31 set; S33 archived S32; S34 archived S33; S35 archived S34; S36 archived S35; S37 archived S36; S38 archived S37; S40 archived S39; S41 archived S40) to keep this handoff lean. The current (S41) scope contract is above; the archive holds the prior-session archaeology.
...
- **SINGLE TRUNK** unchanged (since S22). Suite **247 passed / 2 skipped** (+19 build+Tier-3 tests; the 2 skips are pre-existing Linux-only egress-namespace tests); branch-completeness 0 violations (20 agents); all hook suites green. `main` at the Wave-6 merge as of 2026-06-07 S41 close + this S41 close PR.

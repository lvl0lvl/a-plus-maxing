...
- **Beads:** 3 closed (`nue` #83, `3lv`+`dv3` #84). Filed: `2kk` (P3, two-line postal extension), `46m` (P2, operator email in PUBLIC git history — Walter method-decision pending), `token_config` rename (P3), the bd-auto-stage commit-scan mechanism (P2). **DEFERRED to S46:** `am4` (P2), the dashboard demo (AC5).
...
- **Filed S45 (open follow-ups):** `46m` P2 (operator email in PUBLIC git history — **Walter method-decision pending**: make-private vs history-rewrite), `2kk` P3 (two-line postal address extension, #83), + `token_config` rename (P3) and the commit-hook bd-auto-stage scan (P2) from the #84 review.

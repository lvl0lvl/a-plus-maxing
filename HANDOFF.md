...
- **Tests:** +13 new (9 `test_confirm_curation.py`, 2 referral in `test_app_shell.py`, 4 `test_front_end_wiring_e2e.py` — a markup-grounded UI-driven E2E); terminal suite 2118/0. JS `node --check`-clean.

...
Scope contracts for Sessions 5-76 + their evaluations were moved to `vault/sessions/scope-contract-archive.md` (S32 archived the S5-31 set; …; S75 archived S74; S76 archived S75; S77 archived S76) to keep this handoff lean. The current (S77) scope contract is above; the archive holds the prior-session archaeology.

...
| `feature/wiki-metabolic` worktree | **Metabolic — CMP organ markers** — ALT ✓, AST ✓, eGFR/creatinine ✓, albumin, sodium, potassium (6 entries; the executor-judged CMP liver/kidney/electrolyte subset worth standalone entries) | 1 | standard | **IN PROGRESS** — 3/6 done (ALT/AST/eGFR ingested, gates attested + bda-clean); albumin/sodium/potassium remain | 2026-06-20 |

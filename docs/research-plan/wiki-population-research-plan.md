...
| `feature/wiki-metabolic` worktree | **Metabolic — CMP organ markers** — ALT, AST, eGFR/creatinine, albumin, sodium, potassium (6 entries; the executor-judged CMP liver/kidney/electrolyte subset worth standalone entries) | 1 | standard | **IN PROGRESS** — claimed 2026-06-20 | 2026-06-20 |

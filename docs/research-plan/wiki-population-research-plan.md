...
| `feature/wiki-metabolic` worktree | **Metabolic — glycemic core** — fasting glucose ✓, HbA1c ✓, fasting insulin, HOMA-IR (4 entries) | 1 | standard | **IN PROGRESS** — fasting-glucose + HbA1c DONE (gates 2.75/3.5/4.25/4.75 attested + bda-clean; ingested); fasting-insulin / HOMA-IR remain | 2026-06-19 |

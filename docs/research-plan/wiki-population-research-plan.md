...
| `feature/wiki-metabolic` worktree | **Hormones (endocrine)** — total testosterone ✓, free testosterone ✓, SHBG ✓, estradiol ✓, cortisol (AM) ✓, DHEA-S ✓, IGF-1 (7 entries) | 1 | standard | **IN PROGRESS** — 6/7 done (total-T/free-T/SHBG/estradiol/cortisol/DHEA-S ingested, gates attested + bda-clean); IGF-1 remains | 2026-06-20 |
